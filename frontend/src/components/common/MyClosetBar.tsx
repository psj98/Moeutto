  ...
  return (
    <>
      <div className="flex gap-3 justify-center mt-4 mb-4">
        <div
          className={`w-[20%] h-[65px] max-w-[250px] min-w-[92px] tracking-wider text-GmarketSansLight shadow-md flex items-center justify-center rounded-2xl bg-gray-button ${
