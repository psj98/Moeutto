...
def crawl(start, title_list, url_list, category_list, price_list):
    print(start, " start")
...
if __name__ == '__main__':
    ...
    pool.starmap(crawl, [(start + 1, title_list, url_list, category_list, price_list) for start in range(20)])
    pool.close()
    pool.join()
